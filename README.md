...
> 说明：本 README 根据仓库中现有 `README.md` 原始内容和 `docs/index.html` 报告整理。未包含原始 CSV、SQL 脚本、Notebook、Power BI 文件或 Python 重建脚本，因此不将本仓库描述为可完整复现的数据工程项目。
...
```text
https://cljin-m.github.io/Ecommerce-conversion-performance-analytics/
```
